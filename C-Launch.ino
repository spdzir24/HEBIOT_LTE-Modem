...
#define AAC_FILENAME "/RickAstley24.aac"
#define MP3_FILENAME "/44100.mp3"
#define MJPEG_FILENAME "/RickAstley24.mjpeg"
...
/* ===================== SPI / SD-Pins (gemeinsamer Bus) ===================== */
// SPI: SCK=6, MOSI=7, MISO=8
#define SPI_SCK   6
#define SPI_MOSI  7
#define SPI_MISO  20
...
// Für Kompatibilität
#define SDMMC_D3   12  //CS
#define SDMMC_CMD  9  //MOSI
#define SDMMC_CLK  13 //SCK
#define SDMMC_D0   8  //MISO
...
//#define GFX_BL   12  // Backlight (PWM möglich)
#define GFX_RST  11  // Reset
#define GFX_DC   10  // Data/Command
#define GFX_CS   5  // Chip Select
Arduino_DataBus *bus = new Arduino_ESP32SPI(GFX_DC /* DC */, GFX_CS /* CS */, SPI_SCK /* SCK */, SPI_MOSI /* MOSI */, SPI_MISO /* MISO */);
