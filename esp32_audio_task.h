...
#define I2S_BCLK_PIN   2   // BCLK -> MAX98357A BCLK
#define I2S_WS_PIN     1   // LRC/WS -> MAX98357A LRC
#define I2S_DOUT_PIN   4   // DATA OUT -> MAX98357A DIN
...
)
{
    ...
    pin_config.mck_io_num   = I2S_PIN_NO_CHANGE; // MCK nicht verwendet
    pin_config.bck_io_num   = I2S_BCLK_PIN;
    pin_config.ws_io_num    = I2S_WS_PIN;
    pin_config.data_out_num = I2S_DOUT_PIN;
    pin_config.data_in_num  = I2S_PIN_NO_CHANGE; // kein Eingang
